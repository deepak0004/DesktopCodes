...
// 3
// K = 2
void kthsmall( int arr1[], int arr2[], int len1, int len2, int K )
{
   if(len1==0 )
   {
       cout << arr2[K-1];
   ...
   {
     kthsmall( arr1, arr2 + mid2, len1, len2 - mid2, K - mid2 );
   }
   else
   {
     kthsmall( arr1 + mid1, arr2, len1 - mid1, len2, K - mid1 );
   }
}
int main()
{
