...
ll C[1010][1010], P[1010][1010], dp[1010][1010][4], N, M;
ll func( ll r, ll c, bool dir )
{
    ll i, j, k;
    ...
    if( dir )
    {
        o1 = func(r, c+1, dir) + C[r][c];
        o2 = func(r+1, c, !dir) + C[r][c] + P[r][c];
    }
    else
    {
        o1 = func(r+1, c, dir) + C[r][c];
        o2 = func(r, c+1, !dir) + C[r][c] + P[r][c];
    }

    dp[r][c][dir] = min(o1, o2);
    return dp[r][c][dir];
}
int main()
{
