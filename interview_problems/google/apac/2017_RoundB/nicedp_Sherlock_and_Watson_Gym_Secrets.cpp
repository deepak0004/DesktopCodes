...
int main()
{
    ...
    ll i, j, T, A, B, N, K, ans, finalmod = 1000000007, pp, koko, koko2, opop;
    string st;
    ...
    rep(pp, 1, T)
    {
       ...
       rep(i, 0, K-1)
       {
           dp2[i] = ( dp2[i]%finalmod );
       }

       rep(i, 1, K-1)
       {
          koko = ( dp1[i] * dp2[K-i] ) % finalmod;
          ans = (ans + koko) % finalmod;
       }
       koko2 = ( dp1[0] * dp2[0] ) % finalmod;
       ans = (ans + koko2) % finalmod;
       rep(i, 1, K)
       {
           ll o1 = pow_mod(i, A, K);
           ll o2 = pow_mod(i, B, K);
           if( !((o1+o2)%K) )
           {
               ...
               ppyy = (ppyy%finalmod);
               ans = ( ans - ppyy + finalmod ) %finalmod;
           }
       }
