...
int main()
{
    ...
    struct nodee *nod = new nodee;
    nod->val = 1;
    nod->next = new nodee;
    (nod->next)->val = 2;
    (nod->next)->next = new nodee;
    ((nod->next)->next)->val = 3;
    ((nod->next)->next)->next = new nodee;
    (((nod->next)->next)->next)->val = 4;
